...
app.post('/signup', async (req, res) => {
  ...
  try {
    /** 
     * envVariable ==> AUTH_ADDRESS ==> kubernetes generated domain name by using CoreDNS in users-deployment.yaml file ==> `serviceName + nameSpace`
     * envVariable ==> AUTH_SERVICE_SERVICE_HOST ==> kubernetes generated env variable ==> `service name ("-" replace with "_") + _SERVICE_HOST`
     */
